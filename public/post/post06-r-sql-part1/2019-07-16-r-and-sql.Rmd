...
_When analyzing data, many common procedures in SQL can also be performed in R, and vice versa. Here I demonstrate the similarities between the two. For people with a good basic knowledge of either R or SQL, this may make the process of learning the other language more intuitive._
...
```
{{<alert info>}} 
In Part 1 of this series we look at the similarities between SQL and R when _selecting_, _sorting_ and _filtering_ data. In [Part 2](https://www.stevedoogue.com/2019/08/r-and-sql-part2/) we move on to look at _joins_, _grouped data_ and _subqueries_.
{{</alert>}}
