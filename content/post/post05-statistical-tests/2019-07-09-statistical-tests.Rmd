...
Summary: 'My own version of a book which demonstrates that most common statistical tests are special cases of linear models. This offers a simplified and intuitive way to understand statistical tests.'
author: ''
date: '2019-07-09'
